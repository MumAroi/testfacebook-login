...
$redirectURL = 'https://testlogin-facebook.herokuapp.com/index.php'; // Callback URL i.e. page where you want to redirect after 														login, this should be same as oauth login in dashboard
